(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('calendar', ['js/jquery'], factory);
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="上一月" data-calendar-arrow-date></span>',
            ...
            '<span class="prev" title="上一年" data-calendar-arrow-month></span>',
            '<span class="next" title="下一年" data-calendar-arrow-month></span>',
            '</div>',
            '</div>',
